#' example experimental MS1 feature table (retention time subset to 820 -- 940 seconds)
#' 
...
#' @docType data
#' @keywords datasets
#' @name example_Exp_MS1features
#' @format A comma delimited text file with 3720 rows and 15 variables.
